...
All contributions to RubyGems, both by committers and non-commiters, are made
via GitHub pull requests. In particular, no commits should be pushed directly
to master or stable branches. Pull requests are merged using Homu by one of the
maintainers listed in MAINTAINERS.md to ensure that master is always passing on
