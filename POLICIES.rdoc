...
Additionally, when a Ruby version reaches end-of-life the following minor
release of RubyGems will drop backwards compatibility with that Ruby version.

For example, since Ruby 2.2 has reached end-of-life, RubyGems may use require
Ruby 2.3 or later.  As of this writing RubyGems is at versino 3.0, so the
RubyGems version would become 3.1 if it used features only available in Ruby
2.3 and later.

=== Security Release Process

- Obtain CVE numbers as needed from HackerOne or RedHat.
