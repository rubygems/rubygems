...
and provided CI is green, you can go ahead, merge the PR and run `rake release`
from `bundler/` directory in the updated stable branch.
...
* [ ] Run `rake release` from the `bundler/` directory updated stable
...
* [ ] Write a blog post announcing the new version, highlighting new features and
  notable bugfixes
* [ ] Pull the updated stable branch, wait for CI to complete on it and get excited.
* [ ] Run `rake release` in the `bundler/` directory of the updated stable
