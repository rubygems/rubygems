  ...
  class CLI::Gem
    ...
    def run
      ...
      if github_username.empty?
        ...
        changelog_uri = "TODO: Put your gem's CHANGELOG.md URL here." if options["changelog"]
      else
        homepage_uri = "https://github.com/#{github_username}/#{name}"
        source_code_uri = "https://github.com/#{github_username}/#{name}"
        changelog_uri = "https://github.com/#{github_username}/#{name}/blob/main/CHANGELOG.md" if options["changelog"]
      end
