...
module Bundler
  class Definition
    ...
    def filter_relevant(dependencies)
      platforms_array = [Gem::Platform.generic(Bundler.local_platform)].freeze
    ...
    def should_add_extra_platforms?
      !lockfile_exists? && Gem::Platform.generic(Bundler.local_platform) == Gem::Platform::RUBY && !Bundler.settings[:force_ruby_platform]
    end
    ...
    def current_platform_locked?
      @platforms.any? do |bundle_platform|
        Gem::Platform.generic(Bundler.local_platform) == bundle_platform || Bundler.local_platform === bundle_platform
      end
    end
