  ...
  class Definition
    ...
    def initialize(lockfile, dependencies, sources, unlock, ruby_version = nil, optional_groups = [], gemfiles = [])
      ...
      if unlock == true
        ...
        validate_locally_installed_specs = unlock.delete(:dependencies_inconsistent_with_installed_specs)
      ...
      if lockfile_exists?
        ...
        @locked_gems = LockfileParser.new(@lockfile_contents, validate_dependencies: validate_locally_installed_specs)
