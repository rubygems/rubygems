...
module Gem
  ...
  class Platform
    # Can be removed once RubyGems 3.XXX support is dropped
    unless respond_to?(:generic)
      JAVA  = Gem::Platform.new("java").freeze # :nodoc:
      MSWIN = Gem::Platform.new("mswin32").freeze # :nodoc:
      MSWIN64 = Gem::Platform.new("mswin64").freeze # :nodoc:
      MINGW = Gem::Platform.new("x86-mingw32").freeze # :nodoc:
      X64_MINGW = [Gem::Platform.new("x64-mingw32").freeze,
                   Gem::Platform.new("x64-mingw-ucrt").freeze].freeze # :nodoc:
      UNIVERSAL_MINGW = Gem::Platform.new("universal-mingw").freeze # :nodoc:
      WINDOWS = [MSWIN, MSWIN64, UNIVERSAL_MINGW].freeze # :nodoc:
      X64_LINUX = Gem::Platform.new("x86_64-linux").freeze # :nodoc:
      X64_LINUX_MUSL = Gem::Platform.new("x86_64-linux-musl").freeze # :nodoc:
