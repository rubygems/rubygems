...
RSpec.describe "compact index api" do
  ...
  it "performs full update of compact index info cache if range is not satisfiable" do
    ...
    File.open(rack_info_path, "a") {|f| f << "0.9.2 |checksum:c55b525b421fd833a93171ad3d7f04528ca8e87d99ac273f8933038942a5888c" }
    ...
    resulting_rack_info_content = File.read(rack_info_path)
