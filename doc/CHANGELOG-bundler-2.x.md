...
Bundler's changelog up to 2.7.2, from when it was versioned separately from RubyGems. Since 4.0.0 both share [CHANGELOG.md](https://github.com/ruby/rubygems/blob/master/CHANGELOG.md).
...
### Deprecations:
  ...
  * See the [the upgrading document](https://github.com/ruby/rubygems/blob/c8437ef073bc8466585595b77d70afd9f51ba753/doc/bundler/UPGRADING.md) for a detailed explanation of
