...
# - Gem::URI::Escape - (in uri/common.rb)
...
require 'rubygems/uri/lib/uri/version'
require 'rubygems/uri/lib/uri/common'
require 'rubygems/uri/lib/uri/generic'
require 'rubygems/uri/lib/uri/file'
require 'rubygems/uri/lib/uri/ftp'
require 'rubygems/uri/lib/uri/http'
require 'rubygems/uri/lib/uri/https'
require 'rubygems/uri/lib/uri/ldap'
require 'rubygems/uri/lib/uri/ldaps'
require 'rubygems/uri/lib/uri/mailto'
