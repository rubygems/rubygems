...
class TestGemInstaller < Gem::InstallerTestCase
  FIXTURES = File.expand_path(File.join("..", "fixtures"), __FILE__)
...
gem 'other', version
  ...
  def test_generate_bin_script_templated_notfound
    @installer.wrappers = true
    @installer.wrapper_template = '/file/does/not/exist'
    util_make_exec
    @installer.gem_dir = util_gem_dir
  ...
  def test_generate_bin_script_templated
    @installer.wrappers = true
    @installer.wrapper_template = File.join FIXTURES, 'wrapper.erb'
    util_make_exec
    @installer.gem_dir = util_gem_dir
    ...
    wrapper = File.read installed_exec
    assert_match %r|templated by RubyGems|, wrapper
    assert_match %r|^# spec.name: a$|, wrapper
    assert_match %r|^# spec.version: 2$|, wrapper
  end
