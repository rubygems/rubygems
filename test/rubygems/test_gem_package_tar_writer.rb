...
class TestGemPackageTarWriter < Gem::Package::TarTestCase
  ...
  def test_add_file
    Time.stub :now, Time.at(1_458_518_157) do
      ...
      assert_headers_equal(tar_file_header("x", "", 0o644, 10, Time.at(0).utc),
                         @io.string[0, 512])
    end
  ...
  def test_add_symlink
    Time.stub :now, Time.at(1_458_518_157) do
      ...
      assert_headers_equal(tar_symlink_header("x", "", 0o644, Time.at(0).utc, "y"),
                         @io.string[0, 512])
    end
  ...
  def test_add_file_simple_padding
    Time.stub :now, Time.at(1_458_518_157) do
      ...
      assert_headers_equal tar_file_header("x", "", 0, 100, Time.at(0).utc),
        @io.string[0, 512]
    end
  ...
  def test_mkdir
    Time.stub :now, Time.at(1_458_518_157) do
      ...
      assert_headers_equal tar_dir_header("foo", "", 0o644, Time.at(0).utc),
                           @io.string[0, 512]
